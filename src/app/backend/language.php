...
if(!isset($_POST["username"]) || !isset($_POST["cookie"]) || !isset($_POST["language"]) ){return;}
...
$SQL_QUERY = "UPDATE users SET language = '" . $language . "' WHERE username = '" . $username . "' AND cookie = '" . $cookie . "'";
